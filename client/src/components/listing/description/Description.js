          ...
          <div id={styles.addiDetails}>
            <div className={styles.details}>
              ...
              <div className={styles.detSection}>
                {description.available.substring(10, 0)}
              </div>
            </div>
            <div className={styles.details}>
              <div className={styles.detSection}>Ideal tenants</div>
              <div className={styles.detSection}>
                {description["idealTenants"]}
              </div>
            </div>
            <div className={styles.details}>
          ...
          <div id={styles.propManager}>
            ...
            <div id={styles.propdets}>
              ...
              <div id={styles.stuff}>
                ...
                <div id={styles.name}>
                  {description["propertyManager"].name}
                </div>
              </div>
            </div>
            <div id={styles.propcontact}>
              <div id={styles.phone}>
                ...
                <div>{`${description["propertyManager"].number}`}</div>
              </div>
              <div id={styles.email}>
                <img id={styles.emailimg} src={mail} alt="mail" />
                <div>{`${description["propertyManager"].email}`}</div>
              </div>
            </div>
          </div>
